...
# print(model)
model = models.shufflenet_v2_x0_5(progress=True)
for param in model.parameters():
    param.requires_grad = True
print(model)
# out = torch.randn(1, 3, 256, 256)
# # print(out)
# vis_graph = make_dot(model(out), params=dict(model.named_parameters()))
# vis_graph.view()
# 构建新的全连接层
...
for epoch in range(Init_Epoch, Freeze_Epoch):
    ...
    test.to_csv('csv/shufflenetv2.csv', encoding='utf-8')
